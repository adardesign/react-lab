          ...
          <div className="category-container layout-80-20 layout-reverse clear">
            ...
            <div className="col2">
                <div className="category-aside-nav">
                  ...
                  {this.state.deviceType === "mobile" && <FeaturedBrands brands={this.state.currentCatagory.featuredBrands} />}
